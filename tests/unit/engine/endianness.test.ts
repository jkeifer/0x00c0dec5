...
// The bitround (keepBits) byte-order-invariance coverage that used to live
// here tested `assignType`'s keepBits path directly, which moved with the
// behavior itself to the bitround codec (codec-unification typeAssignment
