...
import { runCodecPipeline, shannonEntropy } from '../../../src/engine/codecs.ts';
...
import type { AppState, GenerationMode, LogicalTypeConfig, Variable } from '../../../src/types/state.ts';
