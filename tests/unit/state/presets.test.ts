...
import basicallyParquetRaw from '../../../src/presets/basically-parquet.json';
import basicallyGeotiffRaw from '../../../src/presets/basically-geotiff.json';
import basicallyZarrRaw from '../../../src/presets/basically-zarr.json';
